...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_menu,NEW.id_estabelecimento,'ADDED MENU');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_menu,NEW.id_estabelecimento,'DELETED MENU');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_estabelecimento,'ADDED ITEM');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_estabelecimento,'DELETED ITEM');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_empresa,'ADDED CATEGORY');
	RETURN NEW;
END;$$;

CREATE OR REPLACE FUNCTION REMOVER_EMPRESA()
RETURNS TRIGGER
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_empresa,'DELETED CATEGORY');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_menu,'ADDED MENU ITEM');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_USER,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_menu,'DELETED MENU ITEM');
	RETURN NEW;
END;$$;
