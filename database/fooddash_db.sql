...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_ID,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_menu,NEW.id_estabelecimento,'DELETED MENU');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_ID,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_estabelecimento,'DELETED ITEM');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_ID,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_categoria,NEW.id_empresa,'DELETED CATEGORY');
	RETURN NEW;
END;$$;
...
LANGUAGE PLPGSQL AS $$
BEGIN
	INSERT INTO ACTION_LOGGER(AFFECTED_ID,AFFECTED_COMPANY,ACTION_TYPE) VALUES (NEW.id_item,NEW.id_menu,'DELETED MENU ITEM');
	RETURN NEW;
END;$$;
