...
Título: FoodDash | Aplicação de Entrega de Comida
...
--------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Empresas - 3ª tabela a ser criada --
--------------------------------------------------------------
...
----------------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Estabelecimentos - 4ª tabela a ser criada --
----------------------------------------------------------------------
...
-------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Pedidos - 5ª tabela a ser criada --
-------------------------------------------------------------
CREATE TABLE IF NOT EXISTS Pedidos (
    id_pedido SERIAL PRIMARY KEY,
    data TIMESTAMPTZ DEFAULT NOW(),
    estado VARCHAR(50) DEFAULT 'EM CHECKOUT' CHECK(
        estado IN (
            'EM CHECKOUT',
            'EFETUADO',
            'EM PREPARACAO',
...
----------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Categorias - 6ª tabela a ser criada --
----------------------------------------------------------------
...
-----------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Itens - 7ª tabela a ser criada --
-----------------------------------------------------------
...
-----------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Menus - 8ª tabela a ser criada --
-----------------------------------------------------------
...
------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Opcoes - 9ª tabela a ser criada --
------------------------------------------------------------
...
----------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Avaliacoes - 10ª tabela a ser criada --
----------------------------------------------------------------
...
-------------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Pedido_Itens - 11ª tabela a ser criada --
-------------------------------------------------------------------
...
-------------------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Pedido_Item_Opcoes - 12ª tabela a ser criada --
-------------------------------------------------------------------------
...
-----------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' Item_Menus - 13ª tabela a ser criada --
-----------------------------------------------------------------
...
--------------------------------------------------------------------
-- Tabela 'ptaw-gr2-2024' ACTION_LOGGER - 14ª tabela a ser criada --
--------------------------------------------------------------------
...
================================================================================================
Trigger para verificar se já existe uma avaliação do mesmo cliente para o mesmo estabelecimento. 
Um cliente só pode avaliar um estabelecimento uma vez. 
==============================================================================================*/
...
/*====================================================
Função para inserir um pedido, atualiza se já existir.
====================================================*/
...
/*=============================================================================================
Funções/Triggers para registar a adição e remoção de menus, itens e categorias no log de acções
===============================================================================================

==========================
Função para adicionar menu
========================*/
