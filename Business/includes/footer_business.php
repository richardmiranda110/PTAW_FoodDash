<div class="d-flex flex-column" style="background-color: #202020;">
  <div class="container my-auto">
    ...
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-2 border-top border-bottom" style="color: white;">
      <div class="col mb-3">
        <a href="#"><img id="logo_fooddash" src="./assets/imgs/fd_logo_blackWhite.png" alt="reduced_logo_fd" width="190" height="110"></a>
      </div>
      ...
      <div class="col mb-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0" style="color: white;">Contato empresarial</a></li>
        </ul>
      </div>
    </footer>
