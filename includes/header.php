<nav class="navbar navbar-expand navbar-dark bg-dark z-index-3" style="padding:0;margin:0;" aria-label="Second navbar example">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarsExample02">
      ...
      <button id="loginBtn" type="button" class="btn btn-primary me-2">Login</button>
      <button id="registarBtn" type="button" class="btn btn-secondary">Registar</button>
    </div>
  </div>
</nav>
...
<script>
    ...
    document.getElementById('registarBtn').addEventListener('click', function() {
